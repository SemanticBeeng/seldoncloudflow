...
class FraudTFRESTExecutorTensorTest extends AsyncWordSpec {

  // the model's name.
  val signature = ""
  val modelName = "fraud"
  //  val path = "http://localhost:8003/seldon/seldon/fraud-rest-tfserving/v1/models/fraud/:predict"
  val path = "http://localhost:8000/v1/models/fraud/:predict"
